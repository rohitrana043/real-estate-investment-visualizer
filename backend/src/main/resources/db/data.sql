...
-- Note: In PostgreSQL you may need to run this separately with admin privileges
CREATE DATABASE propertymap;

-- Connect to the propertymap database
\c propertymap;
...
-- Add some procedurally generated properties data
INSERT INTO properties (
    address, city, state, zip_code, bedrooms, bathrooms, square_feet, year_built,
    list_price, status, latitude, longitude, cap_rate, appreciation_rate,
    cash_on_cash_return, monthly_rent, yearly_expenses, image_url, description,
...
SELECT
    ...
    CASE
        ...
        WHEN (random() * 500)::integer % 20 = 2 THEN (100 + (random() * 400)::integer)::text || ' Bay Street, Unit ' || (100 + (random() * 3000)::integer)::text
        WHEN (random() * 500)::integer % 20 = 3 THEN (100 + (random() * 400)::integer)::text || ' Bloor Street West, Unit ' || (100 + (random() * 3000)::integer)::text
        WHEN (random() * 500)::integer % 20 = 4 THEN (100 + (random() * 400)::integer)::text || ' Yonge Street, Unit ' || (100 + (random() * 3000)::integer)::text
        WHEN (random() * 500)::integer % 20 = 5 THEN (100 + (random() * 400)::integer)::text || ' College Street, Unit ' || (100 + (random() * 3000)::integer)::text
        WHEN (random() * 500)::integer % 20 = 6 THEN (100 + (random() * 400)::integer)::text || ' Dundas Street West, Unit ' || (100 + (random() * 3000)::integer)::text
        WHEN (random() * 500)::integer % 20 = 7 THEN (100 + (random() * 400)::integer)::text || ' Front Street West, Unit ' || (100 + (random() * 3000)::integer)::text
        WHEN (random() * 500)::integer % 20 = 8 THEN (100 + (random() * 400)::integer)::text || ' Spadina Avenue, Unit ' || (100 + (random() * 3000)::integer)::text
        WHEN (random() * 500)::integer % 20 = 9 THEN (100 + (random() * 400)::integer)::text || ' University Avenue, Unit ' || (100 + (random() * 3000)::integer)::text
        WHEN (random() * 500)::integer % 20 = 10 THEN (100 + (random() * 400)::integer)::text || ' Richmond Street West, Unit ' || (100 + (random() * 3000)::integer)::text
        WHEN (random() * 500)::integer % 20 = 11 THEN (100 + (random() * 400)::integer)::text || ' Adelaide Street West, Unit ' || (100 + (random() * 3000)::integer)::text
        WHEN (random() * 500)::integer % 20 = 12 THEN (100 + (random() * 400)::integer)::text || ' Wellington Street West, Unit ' || (100 + (random() * 3000)::integer)::text
        WHEN (random() * 500)::integer % 20 = 13 THEN (100 + (random() * 400)::integer)::text || ' Bathurst Street, Unit ' || (100 + (random() * 3000)::integer)::text
        WHEN (random() * 500)::integer % 20 = 14 THEN (100 + (random() * 400)::integer)::text || ' The Esplanade, Unit ' || (100 + (random() * 3000)::integer)::text
        WHEN (random() * 500)::integer % 20 = 15 THEN (100 + (random() * 400)::integer)::text || ' St. Clair Avenue West, Unit ' || (100 + (random() * 3000)::integer)::text
        WHEN (random() * 500)::integer % 20 = 16 THEN (100 + (random() * 400)::integer)::text || ' Fort York Boulevard, Unit ' || (100 + (random() * 3000)::integer)::text
        WHEN (random() * 500)::integer % 20 = 17 THEN (100 + (random() * 400)::integer)::text || ' Queens Quay West, Unit ' || (100 + (random() * 3000)::integer)::text
        WHEN (random() * 500)::integer % 20 = 18 THEN (100 + (random() * 400)::integer)::text || ' Davenport Road, Unit ' || (100 + (random() * 3000)::integer)::text
        ELSE (100 + (random() * 400)::integer)::text || ' Avenue Road, Unit ' || (100 + (random() * 3000)::integer)::text
    END,
    'Toronto', -- city
    'ON', -- state
...
-- Insert GTA (Mississauga, Brampton, Vaughan, Markham, Richmond Hill, Oakville)
INSERT INTO properties (
    address, city, state, zip_code, bedrooms, bathrooms, square_feet, year_built,
    list_price, status, latitude, longitude, cap_rate, appreciation_rate,
    cash_on_cash_return, monthly_rent, yearly_expenses, image_url, description,
...
SELECT
    ...
    CASE
        WHEN i % 6 = 0 THEN
            CASE
                WHEN (random() * 3)::integer = 0 THEN 'L5B ' || ((random() * 9 + 1)::integer)::text || 'M' || ((random() * 9 + 1)::integer)::text
            WHEN (random() * 3)::integer = 1 THEN 'L5R ' || ((random() * 9 + 1)::integer)::text || 'K' || ((random() * 9 + 1)::integer)::text
            ELSE 'L4Z ' || ((random() * 9 + 1)::integer)::text || 'W' || ((random() * 9 + 1)::integer)::text
            END
        WHEN i % 6 = 1 THEN
    CASE
        WHEN (random() * 3)::integer = 0 THEN 'L6Y ' || ((random() * 9 + 1)::integer)::text || 'R' || ((random() * 9 + 1)::integer)::text
        WHEN (random() * 3)::integer = 1 THEN 'L6T ' || ((random() * 9 + 1)::integer)::text || 'L' || ((random() * 9 + 1)::integer)::text
        ELSE 'L6X ' || ((random() * 9 + 1)::integer)::text || 'V' || ((random() * 9 + 1)::integer)::text
    END
WHEN i % 6 = 2 THEN
    CASE
        WHEN (random() * 3)::integer = 0 THEN 'L4K ' || ((random() * 9 + 1)::integer)::text || 'G' || ((random() * 9 + 1)::integer)::text
        WHEN (random() * 3)::integer = 1 THEN 'L4L ' || ((random() * 9 + 1)::integer)::text || 'J' || ((random() * 9 + 1)::integer)::text
        ELSE 'L6A ' || ((random() * 9 + 1)::integer)::text || 'B' || ((random() * 9 + 1)::integer)::text
    END
WHEN i % 6 = 3 THEN
    CASE
        WHEN (random() * 3)::integer = 0 THEN 'L3R ' || ((random() * 9 + 1)::integer)::text || 'W' || ((random() * 9 + 1)::integer)::text
        WHEN (random() * 3)::integer = 1 THEN 'L3P ' || ((random() * 9 + 1)::integer)::text || 'K' || ((random() * 9 + 1)::integer)::text
        ELSE 'L3T ' || ((random() * 9 + 1)::integer)::text || 'G' || ((random() * 9 + 1)::integer)::text
    END
WHEN i % 6 = 4 THEN
    CASE
        WHEN (random() * 3)::integer = 0 THEN 'L4B ' || ((random() * 9 + 1)::integer)::text || 'M' || ((random() * 9 + 1)::integer)::text
        WHEN (random() * 3)::integer = 1 THEN 'L4C ' || ((random() * 9 + 1)::integer)::text || 'K' || ((random() * 9 + 1)::integer)::text
        ELSE 'L4E ' || ((random() * 9 + 1)::integer)::text || 'J' || ((random() * 9 + 1)::integer)::text
    END
ELSE
    CASE
        WHEN (random() * 3)::integer = 0 THEN 'L6H ' || ((random() * 9 + 1)::integer)::text || 'M' || ((random() * 9 + 1)::integer)::text
        WHEN (random() * 3)::integer = 1 THEN 'L6J ' || ((random() * 9 + 1)::integer)::text || 'G' || ((random() * 9 + 1)::integer)::text
        ELSE 'L6L ' || ((random() * 9 + 1)::integer)::text || 'K' || ((random() * 9 + 1)::integer)::text
    END
    END,
    CASE
...
-- Add more procedurally generated location scores
INSERT INTO location_scores (
    latitude, longitude, address, overall_score, performance_score, risk_score,
    demand_score, supply_score, cap_rate, appreciation, irr, five_year_total_return,
    average_house_price, property_tax, neighborhood_change, created_at, updated_at
...
CREATE INDEX idx_location_scores_location ON location_scores(latitude, longitude);
...
SELECT COUNT(*) AS location_score_count FROM location_scores;


-- Add approximately 410 more properties to reach 500+ total
-- This script assumes the existing database structure is already created

-- Add more Toronto properties
INSERT INTO properties (
    address, city, state, zip_code, bedrooms, bathrooms, square_feet, year_built,
    list_price, status, latitude, longitude, cap_rate, appreciation_rate,
    cash_on_cash_return, monthly_rent, yearly_expenses, image_url, description,
...
-- Insert additional GTA (Mississauga, Brampton, Vaughan, Markham, Richmond Hill, Oakville)
INSERT INTO properties (
    address, city, state, zip_code, bedrooms, bathrooms, square_feet, year_built,
    list_price, status, latitude, longitude, cap_rate, appreciation_rate,
    cash_on_cash_return, monthly_rent, yearly_expenses, image_url, description,
...
SELECT
    ...
    CASE
        WHEN i % 10 = 0 THEN
            CASE
                WHEN (random() * 5)::integer = 0 THEN 'King West Area ' || i::text
                WHEN (random() * 5)::integer = 1 THEN 'Queen West Area ' || i::text
                WHEN (random() * 5)::integer = 2 THEN 'Bay Street Corridor ' || i::text
                WHEN (random() * 5)::integer = 3 THEN 'Waterfront Area ' || i::text
                ELSE 'Old Toronto Area ' || i::text
            END
        WHEN i % 10 = 1 THEN
            CASE
                WHEN (random() * 5)::integer = 0 THEN 'Yonge-Eglinton Area ' || i::text
                WHEN (random() * 5)::integer = 1 THEN 'Mount Pleasant Area ' || i::text
                WHEN (random() * 5)::integer = 2 THEN 'Chaplin Estates ' || i::text
                WHEN (random() * 5)::integer = 3 THEN 'Deer Park ' || i::text
                ELSE 'Midtown Area ' || i::text
            END
        WHEN i % 10 = 2 THEN
            CASE
                WHEN (random() * 5)::integer = 0 THEN 'High Park North ' || i::text
                WHEN (random() * 5)::integer = 1 THEN 'Junction Triangle ' || i::text
                WHEN (random() * 5)::integer = 2 THEN 'Swansea Area ' || i::text
                WHEN (random() * 5)::integer = 3 THEN 'Parkdale Area ' || i::text
                ELSE 'West Toronto Area ' || i::text
            END
        WHEN i % 10 = 3 THEN
            CASE
                WHEN (random() * 5)::integer = 0 THEN 'Upper Beaches ' || i::text
                WHEN (random() * 5)::integer = 1 THEN 'Danforth Village ' || i::text
                WHEN (random() * 5)::integer = 2 THEN 'Greenwood-Coxwell ' || i::text
                WHEN (random() * 5)::integer = 3 THEN 'Woodbine Corridor ' || i::text
                ELSE 'East Toronto Area ' || i::text
            END
        WHEN i % 10 = 4 THEN
            CASE
                WHEN (random() * 5)::integer = 0 THEN 'Mississauga City Centre Area ' || i::text
                WHEN (random() * 5)::integer = 1 THEN 'Hurontario Area ' || i::text
                WHEN (random() * 5)::integer = 2 THEN 'Clarkson Area ' || i::text
                WHEN (random() * 5)::integer = 3 THEN 'Lorne Park Area ' || i::text
                ELSE 'Central Mississauga Area ' || i::text
            END
        WHEN i % 10 = 5 THEN
            CASE
                WHEN (random() * 5)::integer = 0 THEN 'Downtown Brampton Area ' || i::text
                WHEN (random() * 5)::integer = 1 THEN 'Fletchers Creek ' || i::text
                WHEN (random() * 5)::integer = 2 THEN 'Heart Lake Area ' || i::text
                WHEN (random() * 5)::integer = 3 THEN 'Northgate Area ' || i::text
                ELSE 'Central Brampton Area ' || i::text
            END
        WHEN i % 10 = 6 THEN
            CASE
                WHEN (random() * 5)::integer = 0 THEN 'VMC Area ' || i::text
                WHEN (random() * 5)::integer = 1 THEN 'Concord Area ' || i::text
                WHEN (random() * 5)::integer = 2 THEN 'Vellore Village ' || i::text
                WHEN (random() * 5)::integer = 3 THEN 'Patterson Area ' || i::text
                ELSE 'Vaughan Area ' || i::text
            END
        WHEN i % 10 = 7 THEN
            CASE
                WHEN (random() * 5)::integer = 0 THEN 'Downtown Markham Area ' || i::text
                WHEN (random() * 5)::integer = 1 THEN 'Greensborough Area ' || i::text
                WHEN (random() * 5)::integer = 2 THEN 'Cathedraltown ' || i::text
                WHEN (random() * 5)::integer = 3 THEN 'Wismer Commons ' || i::text
                ELSE 'Central Markham Area ' || i::text
            END
        WHEN i % 10 = 8 THEN
            CASE
                WHEN (random() * 5)::integer = 0 THEN 'Downtown Richmond Hill ' || i::text
                WHEN (random() * 5)::integer = 1 THEN 'Jefferson Area ' || i::text
                WHEN (random() * 5)::integer = 2 THEN 'Elgin Mills Area ' || i::text
                WHEN (random() * 5)::integer = 3 THEN 'Harding Area ' || i::text
                ELSE 'Central Richmond Hill Area ' || i::text
            END
        ELSE
            CASE
                WHEN (random() * 5)::integer = 0 THEN 'Downtown Oakville Area ' || i::text
                WHEN (random() * 5)::integer = 1 THEN 'Iroquois Ridge ' || i::text
                WHEN (random() * 5)::integer = 2 THEN 'West Oak Trails ' || i::text
                WHEN (random() * 5)::integer = 3 THEN 'River Oaks Area ' || i::text
                ELSE 'Central Oakville Area ' || i::text
            END
    END,
    -- Generate scores and metrics based on area
    CASE
    ...
    END,
    NOW(), NOW()
FROM generate_series(1, 420) as i;
